...
#
# Student 1: Dharma Ong, 1009330109
# Student 2: Yael Lyshkow, 1009560814
...
erase_i:
    ...
    # beq $t9, 0x47f5cf, erase_i_horz         # you are making me cry sob and throw up
    ...
    beq $t7, 0, erase_i_vert
    beq $t7, 1, erase_i_horz
